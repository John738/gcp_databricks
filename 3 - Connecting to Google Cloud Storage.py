...
# MAGIC %python
# MAGIC dbutils.fs.mount("gs://databricksgcplabs","/mnt/odl_user_564377/databricksgcplabs")
...
# MAGIC %fs
# MAGIC ls /mnt/<your-username>/databricksgcplabs
...
# MAGIC %python
# MAGIC dbutils.fs.unmount("/mnt/<your-username>/databricksgcplabs")
...
# MAGIC %python
# MAGIC dbutils.fs.mkdirs("/tmp/<your-username>/data")
# MAGIC dbutils.fs.cp("gs://databricksgcplabs/products","/tmp/<your-username>/data", recurse=True)
# MAGIC dbutils.fs.rm("/tmp/<your-username>/data", recurse=True)
